...
exec 9>/tmp/theme-switcher-niri.lock
flock -n 9 || exit 1
trap 'rm -f /tmp/theme-switcher-niri.lock; exit' EXIT INT TERM
...
generate_hyprlock() {
  ...
  cat >"$file" <<EOF
# Generated by theme-switcher — ${THEME_NAME}
# Do not edit manually. Edit theme-switcher-niri.sh:generate_hyprlock instead.
